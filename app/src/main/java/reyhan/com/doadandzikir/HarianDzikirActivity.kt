...
class HarianDzikirActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_harian_dzikir)

        initData()

        val rvDzikirDoaHarian: RecyclerView = findViewById(R.id.rv_harian_dzikir)
