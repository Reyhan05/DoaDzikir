...
import reyhan.com.doadandzikir.adapter.ArtikelAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupViewPager() {
        val llSliderDots: LinearLayout = findViewById(R.id.ll_slider)
    ...
    private fun initView() {
        ...
        val llDizikirDoaSholat: LinearLayout = findViewById(R.id.ll_dzikir_setelah_solat)
        llDizikirDoaSholat.setOnClickListener {
            startActivity(
        ...
        llDzikirSetiapSaat.setOnClickListener {
            startActivity(
                Intent(this, SetiapSaatDzikirActivity::class.java)
            )
        }
        val llDzikirDoaHarian: LinearLayout = findViewById(R.id.ll_dzikir_harian)
        llDzikirDoaHarian.setOnClickListener {
            startActivity(
                Intent(this, HarianDzikirActivity::class.java)
            )
        }
